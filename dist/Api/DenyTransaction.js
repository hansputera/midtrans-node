...
exports.denyTransaction = void 0;
 ...
 */
function denyTransaction(isProduction, orderID, token) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, ApiRequest_1.apiRequest)(isProduction, 'v2', token).post(`/${orderID}/deny`);
            return data;
        }
        catch (e) {
...
exports.denyTransaction = denyTransaction;
