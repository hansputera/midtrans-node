...
const minusDate = (date, days) => {
	let minDate;
	if (!date) minDate = luxon_1.DateTime.now().minus({ days });
	else {
...
const plussDate = (date, days) => {
	let plusDate;
	if (!date) plusDate = luxon_1.DateTime.now().plus({ days });
	else {
...
function historyTransaction(isProduction, token, fromDate, toDate) {
	...
	return __awaiter(this, void 0, void 0, function* () {
		...
		if (!fromDate._date) {
			...
			!(toDate === null || toDate === void 0 ? void 0 : toDate._date)
		) {
		...
		const isoToDate =
			(_a = toDate === null || toDate === void 0 ? void 0 : toDate._date) ===
				null || _a === void 0
				? void 0
				: _a.toISODate();
		try {
			const { data } = yield (0, IrisRequest_1.irisRequest)(
				isProduction,
				token
			).get('/statements', {
				data: {
