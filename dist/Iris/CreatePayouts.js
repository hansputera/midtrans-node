 ...
 */
function createPayouts(isProduction, args, token) {
    var _a;
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, IrisRequest_1.irisRequest)(isProduction, token).post('/payouts', args);
            return data;
        }
        catch (e) {
...
exports.createPayouts = createPayouts;
