...
class MidtransNode {
    ...
    constructor(isProduction, authKey) {
         ...
         */
        this.createTransaction = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Snap_1.createTransaction)(this.config.productionMode, args, this.config); });
        /**
         ...
         */
        this.captureTransaction = (orderID, grossAmount) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.captureTransaction)(this.config.productionMode, orderID, this.config.authKey, grossAmount);
        });
        /**
         ...
         */
        this.cancelTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.cancelTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.approveTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.approveTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.denyTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.denyTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.refundTransaction = (orderID, args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.refundTransaction)(this.config.productionMode, orderID, args, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         * @description More info: https://api-docs.midtrans.com/#direct-refund-transaction
         */
        this.directRefundTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.directRefundTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.statusTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.statusTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.statusb2bTransaction = (orderID, page = 0, perPage = 10) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.statusB2bTransaction)(this.config.productionMode, orderID, page, perPage, this.config.authKey);
        });
        /**
         ...
         */
        this.registerCard = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.registerCard)(this.config.productionMode, args, this.config.authKey); });
        /**
         ...
         */
        this.pointInquiry = (tokenId, grossAmount) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.pointInquiry)(this.config.productionMode, tokenId, this.config.authKey, grossAmount);
        });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         * @description More info: https://api-docs.midtrans.com/#expire-transaction
         */
        this.expireTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.expireTransaction)(this.config.productionMode, orderID, this.config.authKey);
        });
        /**
         *
         ...
         */
        this.createPayAccount = (args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.createPayAccount)(this.config.productionMode, args, this.config.authKey);
        });
        /**
         * @param {string} accountID - Pay Account ID
         * @description More info: https://api-docs.midtrans.com/#get-pay-account
         */
        this.getPayAccount = (accountID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.getPayAccount)(this.config.productionMode, accountID, this.config.authKey);
        });
        /**
         * @param {string} accountID - Pay Account ID
         * @description More info: https://api-docs.midtrans.com/#unbind-pay-account
         */
        this.unbindPayAccount = (accountID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.unbindPayAccount)(this.config.productionMode, accountID, this.config.authKey);
        });
        /**
         ...
         */
        this.getBin = (binNumber) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.getBinNumber)(this.config.productionMode, binNumber, this.config.authKey);
        });
        /**
         ...
         */
        this.createSubscription = (args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.createSubscription)(this.config.productionMode, args, this.config.authKey);
        });
        /**
        ...
        this.getSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.getSubscription)(this.config.productionMode, subscriptionId, this.config.authKey);
        });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
         ...
         */
        this.updateSubscription = (subscriptionId, args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.updateSubscription)(this.config.productionMode, subscriptionId, args, this.config.authKey);
        });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
        ...
        this.disableSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.disableSubscription)(this.config.productionMode, subscriptionId, this.config.authKey);
        });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
        ...
        this.enableSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.enableSubscription)(this.config.productionMode, subscriptionId, this.config.authKey);
        });
        /**
         * @description Returns pong message for monitoring purpose
         */
        this.ping = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.ping)(this.config.productionMode, this.config.authKey); });
        /**
         ...
         */
        this.createBeneficiaries = (args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.createBeneficiaries)(this.config.productionMode, args, this.config.authKey);
        });
        /**
         ...
         */
        this.updateBeneficiaries = (aliasName, args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.updateBeneficiaries)(this.config.productionMode, aliasName, args, this.config.authKey);
        });
        /**
         ...
         */
        this.listBeneficiaries = (limit = 10) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.listBeneficiaries)(this.config.productionMode, limit, this.config.authKey);
        });
        /**
         ...
         */
        this.createPayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.createPayouts)(this.config.productionMode, args, this.config.authKey); });
        /**
         ...
         */
        this.approvePayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.approvePayouts)(this.config.productionMode, args, this.config.authKey); });
        /**
         ...
         */
        this.rejectPayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.rejectPayouts)(this.config.productionMode, args, this.config.authKey); });
        /**
         ...
         */
        this.getPayoutDetails = (refNo) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.getPayoutDetails)(this.config.productionMode, refNo, this.config.authKey);
        });
        /**
         ...
         */
        this.historyTransaction = (fromDate, toDate) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.historyTransaction)(this.config.productionMode, this.config.authKey, fromDate, toDate);
        });
        /**
         * @description Provide top up information channel for Aggregator Partner
         */
        this.topupChannels = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.topupChannels)(this.config.productionMode, this.config.authKey); });
        /**
         ...
         */
        this.bankAccounts = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.bankAccounts)(this.config.productionMode, this.config.authKey); });
        /**
         ...
         */
        this.checkBankBalance = (bankAccountID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.checkBankBalance)(this.config.productionMode, bankAccountID, this.config.authKey);
        });
        /**
         * @description - Show list of supported banks in IRIS. More info: https://iris-docs.midtrans.com/#list-banks
         */
        this.listBanks = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.beneficiaryBanks)(this.config.productionMode, this.config.authKey); });
        /**
         ...
         */
        this.validateBankAccount = (bankName, accountID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.validateBankAccount)(this.config.productionMode, bankName, accountID, this.config.authKey);
        });
        /**
         * Charge transaction.
         *
         ...
         */
        this.chargeTransaction = (args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.chargeTransaction)(this.config.productionMode, args, this.config.authKey);
        });
        this.config = {
