 ...
 * Bank types.
 */
export declare type Banks = 'bca' | 'bni' | 'mandiri' | 'cimb' | 'bri' | 'danamon' | 'maybank' | 'mega';
/**
 * Allowed Bins type.
 */
export declare type allowedBins = 'bni' | 'bca' | 'mandiri' | 'cimb' | 'bri' | 'maybank';
/**
 * Credit card type.
 */
 ...
 * BNI Va Interface
 */
export declare type BniVa = BaseVa;
/**
 * BRI VA Number
 */
export declare type BriVa = BaseVa;
/**
 * Gopay interface.
 */
