...
class MidtransNode {
    ...
    constructor(isProduction, authKey) {
         ...
         */
        this.createTransaction = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Snap_1.createTransaction)(this.isProduction, args, this.authKey); });
        /**
        ...
        this.captureTransaction = (orderID, grossAmount) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.captureTransaction)(this.isProduction, orderID, grossAmount, this.authKey);
        });
        /**
         ...
         */
        this.cancelTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.cancelTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.approveTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.approveTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.denyTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.denyTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.refundTransaction = (orderID, args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.refundTransaction)(this.isProduction, orderID, args, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         * @description More info: https://api-docs.midtrans.com/#direct-refund-transaction
         */
        this.directRefundTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.directRefundTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         ...
         */
        this.statusTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.statusTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
        ...
        this.statusb2bTransaction = (orderID, page = 0, perPage = 10) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.statusB2bTransaction)(this.isProduction, orderID, page, perPage, this.authKey);
        });
        /**
         ...
         */
        this.registerCard = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.registerCard)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.pointInquiry = (tokenId, grossAmount) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.pointInquiry)(this.isProduction, tokenId, grossAmount, this.authKey); });
        /**
         * @param {string} orderID - Transaction ID given by Midtrans
         * @description More info: https://api-docs.midtrans.com/#expire-transaction
         */
        this.expireTransaction = (orderID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.expireTransaction)(this.isProduction, orderID, this.authKey); });
        /**
         ...
         */
        this.createPayAccount = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.createPayAccount)(this.isProduction, args, this.authKey); });
        /**
         * @param {string} accountID - Pay Account ID
         * @description More info: https://api-docs.midtrans.com/#get-pay-account
         */
        this.getPayAccount = (accountID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.getPayAccount)(this.isProduction, accountID, this.authKey); });
        /**
         * @param {string} accountID - Pay Account ID
         * @description More info: https://api-docs.midtrans.com/#unbind-pay-account
         */
        this.unbindPayAccount = (accountID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.unbindPayAccount)(this.isProduction, accountID, this.authKey); });
        /**
         ...
         */
        this.getBin = (binNumber) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.getBinNumber)(this.isProduction, binNumber, this.authKey); });
        /**
         ...
         */
        this.createSubscription = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.createSubscription)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.getSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.getSubscription)(this.isProduction, subscriptionId, this.authKey); });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
        ...
        this.updateSubscription = (subscriptionId, args) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Api_1.updateSubscription)(this.isProduction, subscriptionId, args, this.authKey);
        });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
         ...
         */
        this.disableSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.disableSubscription)(this.isProduction, subscriptionId, this.authKey); });
        /**
         * @param {string} subscriptionId - Subscription ID given by Midtrans
         ...
         */
        this.enableSubscription = (subscriptionId) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.enableSubscription)(this.isProduction, subscriptionId, this.authKey); });
        /**
         * @description Returns pong message for monitoring purpose
         */
        this.ping = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.ping)(this.isProduction, this.authKey); });
        /**
         ...
         */
        this.createBeneficiaries = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.createBeneficiaries)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.updateBeneficiaries = (aliasName, args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.updateBeneficiaries)(this.isProduction, aliasName, args, this.authKey); });
        /**
         ...
         */
        this.listBeneficiaries = (limit = 10) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.listBeneficiaries)(this.isProduction, limit, this.authKey); });
        /**
         ...
         */
        this.createPayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.createPayouts)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.approvePayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.approvePayouts)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.rejectPayouts = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.rejectPayouts)(this.isProduction, args, this.authKey); });
        /**
         ...
         */
        this.getPayoutDetails = (refNo) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.getPayoutDetails)(this.isProduction, refNo, this.authKey); });
        /**
         ...
         */
        this.historyTransaction = (fromDate, toDate) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.historyTransaction)(this.isProduction, fromDate, toDate, this.authKey); });
        /**
         * @description Provide top up information channel for Aggregator Partner
         */
        this.topupChannels = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.topupChannels)(this.isProduction, this.authKey); });
        /**
         ...
         */
        this.bankAccounts = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.bankAccounts)(this.isProduction, this.authKey); });
        /**
         ...
         */
        this.checkBankBalance = (bankAccountID) => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.checkBankBalance)(this.isProduction, bankAccountID, this.authKey); });
        /**
         * @description - Show list of supported banks in IRIS. More info: https://iris-docs.midtrans.com/#list-banks
         */
        this.listBanks = () => __awaiter(this, void 0, void 0, function* () { return yield (0, Iris_1.beneficiaryBanks)(this.isProduction, this.authKey); });
        /**
        ...
        this.validateBankAccount = (bankName, accountID) => __awaiter(this, void 0, void 0, function* () {
            return yield (0, Iris_1.validateBankAccount)(this.isProduction, bankName, accountID, this.authKey);
        });
        this.chargeTransaction = (args) => __awaiter(this, void 0, void 0, function* () { return yield (0, Api_1.chargeTransaction)(this.isProduction, args, this.authKey); });
    }
}
