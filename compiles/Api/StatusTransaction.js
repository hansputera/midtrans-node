 ...
 */
function statusTransaction(isProduction, orderID, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, ApiRequest_1.apiRequest)(isProduction, 'v2', token).get(`/${orderID}/status`);
            return data;
        }
        catch (e) {
...
exports.statusTransaction = statusTransaction;
