...
exports.directRefundTransaction = void 0;
 ...
 */
function directRefundTransaction(isProduction, orderID, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, ApiRequest_1.apiRequest)(isProduction, 'v2', token).post(`/${orderID}/refund/online/direct`);
            return data;
        }
        catch (e) {
...
exports.directRefundTransaction = directRefundTransaction;
