...
function ApproveTransaction(isProduction, orderID, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, ApiRequest_1.default)(isProduction, "v2", token).post(`/${orderID}/approve`);
            return data;
        }
        catch (e) {
...
exports.default = ApproveTransaction;
