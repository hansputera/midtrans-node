...
exports.createPayAccount = void 0;
 ...
 */
function createPayAccount(isProduction, args, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, ApiRequest_1.apiRequest)(isProduction, 'v2', token).post('/pay/account', args);
            return data;
        }
        catch (e) {
...
exports.createPayAccount = createPayAccount;
