 ...
 */
function topupChannels(isProduction, token) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { data } = yield (0, IrisRequest_1.irisRequest)(isProduction, token).get('/channels');
            return data;
        }
        catch (e) {
...
exports.topupChannels = topupChannels;
