...
class MidtransNode
{
     ...
     */
    public createTransaction = async (args: SnapTransaction): Promise<{token: string;redirect_url: string;} | undefined> => await CreateTransaction(this.isProduction, args);
     ...
     */
    public captureTransaction = async (orderID: string, grossAmount?: number): Promise<ITransaction | ITransactionFail> => await CaptureTransaction(this.isProduction, orderID, grossAmount);
     ...
     */
    public cancelTransaction = async (orderID: string): Promise<ITransaction | ITransactionFail> => await CancelTransaction(this.isProduction, orderID);
     ...
     */
    public approveTransaction = async (orderID: string): Promise<ITransaction | ITransactionFail> => await ApproveTransaction(this.isProduction, orderID);
     ...
     */
    public denyTransaction = async (orderID: string): Promise<ITransaction | ITransactionFail> => await DenyTransaction(this.isProduction, orderID);
     ...
     */
    public refundTransaction = async (orderID: string, args: IRefundObjRequest): Promise<IRefundObj | ITransactionFail> => await RefundTransaction(this.isProduction, orderID, args);
     ...
     */
    public directRefundTransaction = async (orderID: string): Promise<IRefundObj | ITransactionFail> => await DirectRefundTransaction(this.isProduction, orderID);
     ...
     */
    public statusTransaction = async (orderID: string): Promise<ITransactionStatus | ITransactionFail> => await StatusTransaction(this.isProduction, orderID);
     ...
     */
    public statusb2bTransaction = async (orderID: string, page = 0, per_page = 10): Promise<{status_code: string;status_message: string;transactions: ITransaction[];} | undefined> => await StatusB2bTransaction(this.isProduction, orderID, page, per_page);
     ...
     */
    public registerCard = async (args: IRegisterCardRequest): Promise<IRegisterCardResponse | undefined> => await RegisterCard(this.isProduction, args);
     ...
     */
    public pointInquiry = async (tokenId: string, grossAmount?: number): Promise<IPointInquiry | undefined> => await PointInquiry(this.isProduction, tokenId, grossAmount);
     ...
     */
    public expireTransaction = async (orderID: string): Promise<ITransaction | ITransactionFail> => await ExpireTransaction(this.isProduction, orderID);
     ...
     */
    public createPayAccount = async (args: ICreatePayAccount): Promise<ICreatePayAccountResponse | undefined> => await CreatePayAccount(this.isProduction, args);
     ...
     */
    public getPayAccount = async (accountID: string): Promise<IPayAccount | undefined> => await GetPayAccount(this.isProduction, accountID);
     ...
     */
    public unbindPayAccount = async (accountID: string): Promise<IPayAccountUnBind | undefined> => await UnbindPayAccount(this.isProduction, accountID);
     ...
     */
    public getBin = async (binNumber: number): Promise<BinApiResponse | undefined> => await GetBinNumber(this.isProduction, binNumber);
     ...
     */
    public createSubscription = async (args: ICreateSubcription): Promise<ISubcription | undefined> => await CreateSubscription(this.isProduction, args);
     ...
     */
    public getSubscription = async (subscriptionId: string): Promise<ISubcription | undefined> => await GetSubscription(this.isProduction, subscriptionId);
     ...
     */
    public updateSubscription = async (subscriptionId: string, args: IUpdateSubcription): Promise<ISubcription | undefined> => await UpdateSubscription(this.isProduction, subscriptionId, args);
     ...
     */
    public disableSubscription = async (subscriptionId: string): Promise<{status_message: string;} | undefined> => await DisableSubscription(this.isProduction, subscriptionId);
     ...
     */
    public enableSubscription = async (subscriptionId: string): Promise<{status_message: string;} | undefined> => await EnableSubscription(this.isProduction, subscriptionId);

    /**
     * 
     * @description Returns pong message for monitoring purpose
     */
    public ping = async(): Promise<string | undefined> => await Ping(this.isProduction);
     ...
     */
    public createBeneficiaries = async(args: IBeneficiaries): Promise<ISuccessBeneficiaries | undefined> => await CreateBeneficiaries(this.isProduction, args);
     ...
     */
    public updateBeneficiaries = async(aliasName: string, args: IBeneficiaries): Promise<ISuccessBeneficiaries | undefined> => await UpdateBeneficiaries(this.isProduction, aliasName, args);
     ...
     */
    public listBeneficiaries = async(limit = 10): Promise<IBeneficiaries[] | undefined> => await ListBeneficiaries(this.isProduction, limit);
     ...
     */
    public createPayouts = async(args: IPayoutRequest): Promise<IPayoutCreateResponse | undefined> => await CreatePayouts(this.isProduction, args);
     ...
     */
    public approvePayouts = async(args: IPayoutApproveRequest): Promise<IPayoutSuccessAct | undefined> => await ApprovePayouts(this.isProduction, args);
     ...
     */
    public rejectPayouts = async(args: IPayoutRejectRequest): Promise<IPayoutSuccessAct | undefined> => await RejectPayouts(this.isProduction, args);
     ...
     */
    public getPayoutDetails = async(refNo: string): Promise<IPayout | undefined> => await GetPayoutDetails(this.isProduction, refNo);
     ...
     */
    public historyTransaction = async(fromDate?: IStatementDate, toDate?: IStatementDate): Promise<IStatementResult[] | undefined> => await HistoryTransaction(this.isProduction, fromDate, toDate);

    /**
     * 
     * @description Provide top up information channel for Aggregator Partner
     */
    public topupChannels = async(): Promise<ITopupAggreratorChannel[] | undefined> => await TopupChannels(this.isProduction);
     ...
     */
    public bankAccounts = async(): Promise<BankAccount[] | undefined> => await BankAccounts(this.isProduction);
     ...
     */
    public checkBankBalance = async(bankAccountID: string): Promise<ICheckBalanceBank | undefined> => await CheckBankBalance(this.isProduction, bankAccountID);

    /**
     * 
     * @description Show list of supported banks in IRIS. More info: https://iris-docs.midtrans.com/#list-banks
     */
    public listBanks = async(): Promise<BeneficiaryBank[] | undefined> => await BeneficiaryBanks(this.isProduction);
     ...
     */
    public validateBankAccount = async(bankName: string, accountID: string): Promise<IValidateBankResult | undefined> => await ValidateBankAccount(this.isProduction, bankName, accountID);
}
